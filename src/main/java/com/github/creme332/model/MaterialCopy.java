...
/**
 * An object storing information about a physical representation of a material.
 * A material can have multiple copies.
 */
public class MaterialCopy {
    ...
    /**
     * Simple constructor which sets sensible default values.
     * 
     * @param materialId
     * @param condition
     */
    public MaterialCopy(int materialId) {
        this.barcode = -1;
        this.materialId = materialId;
        this.location = new MaterialLocation(1, 1, 1);
        this.condition = MaterialCondition.NEW;
    }

    /**
     * Constructor for creating a new material copy of unknown barcode. Barcode will
     * be generated by DB.
     * 
     * @param barcode
     * @param materialId
     ...
     * @param condition
     */
    public MaterialCopy(int materialId, MaterialLocation location, int orderId,
    ...
    public static void save(MaterialCopy materialCopy) throws SQLException {
        final Connection conn = DatabaseConnection.getConnection();
        String query = """
                INSERT INTO material_copy (material_id,
                                            order_id,
                                            `condition`,
                                             shelf_no,
                                              aisle_no,
        ...
        try (PreparedStatement preparedStatement = conn.prepareStatement(query)) {
            ...
            preparedStatement.setNull(2, java.sql.Types.INTEGER);// TODO : Update later
